...
- [ ] Database should be in its own container and/or volume mounted to make it persistent, not ephemeral
- [ ] Move migration from Dockerfile `RUN` to `CMD` if database is moved to another container
